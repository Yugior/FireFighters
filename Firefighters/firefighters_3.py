...
class Bombero(Agent):
    ...
    def step(self):
        ...
        if self.pos in self.model.base_position and self.tieneCivil:
            self.tieneCivil = False
            self.model.entregar_civil_en_base()
        ...
        while self.energia_actual > 0:
            ...
            if self.tieneCivil:
                if self.pos != self.model.base_position:
                    accion_realizada = self.mover_hacia(self.model.base_position)
                else:
...
class Tablero(Model):
    def __init__(self, width=8, height=6, num_agentes=6, tipo_agente=None, archivo_config=None):
        ...
        self.schedule = []
        self.current_id = 0
        self.base_position = [(1,1), (0,5)]  # 4 bases
        ...
        self.done = False      # ya termino la simulacion?
    ...
    def step(self):
        ...
        if terminado:
            ...
            # Marcamos el tipo específico de derrota
