...
class Tablero(Model):
    def __init__(self, width=8, height=6, num_agentes=6, tipo_agente=None, archivo_config=None):
        ...
        self.end_reason = None # Texto: "4 civiles heridos", "Edificio colapsado", etc.
        self.end_code = None
    ...
    def step(self):
        ...
        # 2.5 Verificar condición de VICTORIA (7 civiles rescatados)
